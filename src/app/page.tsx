        ...
        <div className="mx-auto w-full max-w-4xl space-y-8">
          <div className="gap-2 flex justify-between">
            ...
            <BlurFade delay={BLUR_FADE_DELAY}>
              <Avatar className="size-28 border border-gray-600">
        ...
        <section id="professional">
          <div className="space-y-12 w-full py-12">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 max-w-4xl mx-auto">
              {professionalProjects.map((project, id) => (
                <BlurFade
                  key={project.title}
                ...
                >
                  <ProjectCard
                    ...
                    links={project.links as readonly { icon: React.ReactNode; type: string; href: string; }[]}
                  />
                </BlurFade>
              ))}
            </div>
              ...
              {personalProjects.map((project, id) => (
                ...
                >
                  <ProjectCard
                    ...
                    image={'image' in project ? project.image : undefined}
                    video={'video' in project ? (project.video as string) : undefined}
                    links={Array.isArray(project.links) ? project.links as { icon: React.ReactNode; type: string; href: string; }[] : undefined}
                  />
                </BlurFade>
              ))}
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center">
                <Button asChild className="gap-2">
                  <Link href={DATA.resume.url} download target="_blank">
                    <Icons.download className="size-4" />
                    {DATA.resume.downloadText}
                  </Link>
                </Button>
              </div>
            </div>
